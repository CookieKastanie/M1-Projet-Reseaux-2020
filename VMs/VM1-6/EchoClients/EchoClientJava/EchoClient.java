  ...
  public static void main(String[] args) throws IOException, InterruptedException{
    ...
    try {
      while (true) {
        ...
        lu = in.readLine();
		System.out.print("Lecture d'un message du serveur attente ...");
        ...
        if (tampon == null) {
		  ...
		  System.out.print("Fermeture de la socket ...");
	  	  Thread.sleep( time_sleep );//#################################
		  System.out.println(" DONE.");


		  /* terminaison explicite de la socket
            dans le sens client -> serveur */
          /* On ne sort pas de la boucle tout de suite ... */
        } else {
            /* envoi des données */
          out.println(tampon);
		System.out.print("Envoie de données au serveur...");
	  	Thread.sleep( time_sleep );//######################################
		System.out.println(" DONE.");
        }
      }
